// correction: slight bug when it comes to leaf nodes on query, refer to battlefield.cpp
...
//    freopen("a.out", "w", stdout);
    ...
    while(q--) {
        ...
        assert(debugCountRecursions <= 70); // log1.5(N) * 2 + 10
